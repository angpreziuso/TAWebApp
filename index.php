<!--
    Index.html - Landing page for our TO-BE named Digital Whiteboard application.
...
<body>
    ...
    <div class="w3-top">
        <div class="w3-bar w3-white w3-card w3-left-align w3-large">
            <a class="w3-bar-item w3-button w3-hide-medium w3-hide-large w3-right w3-padding-large w3-hover-purple w3-large w3-purple" href="javascript:void(0);" onclick="myFunction()" title="Toggle Navigation Menu"><i class="fa fa-bars"></i></a>
            ...
            <a href="scheduleReq.html" class="w3-bar-item w3-button w3-hide-small w3-padding-large">Schedule Request</a>
            <a href="forum.html" class="w3-bar-item w3-button w3-hide-small w3-padding-large">Forum</a>
        </div>
    </div>

    <!-- Header -->
    <header class="w3-container w3-purple w3-center" style="padding:128px 16px">
        <h1 id="JMUCS" class="w3-margin w3-jumbo">JMU Computer Science</h1>
        <p id="JMUCS" class="w3-xlarge">TA Hours</p>
        <button class="w3-button w3-black w3-padding-large w3-large w3-margin-top" onclick="document.getElementById('id01').style.display='block'">Login</button>
        ...
        <button class="w3-button w3-black w3-padding-large w3-large w3-margin-top" onclick="document.getElementById('id02').style.display='block'">Sign Up</button>
        ...
        <div id="id02" class="modal">
            ...
            <form class="modal-content" action="/action_page.php">
                <div class="container">
                    ...
                    <hr>
                    <button id="student" type="button" class="Student">Student</button>
                    <button id="ta" type="button" class="TA">TA</button>
                    <button id="admin" type="button" class="Admin">Admin</button>
                    <br>
    ...
    <div class="w3-container w3-black w3-center w3-padding-64">
        <h1 class="w3-margin w3-text-light-grey w3-xlarge">Quote of the day: if it breaks... you're one step closer.</h1>
    </div>
