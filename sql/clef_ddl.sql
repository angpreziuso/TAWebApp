...
CREATE TABLE SHIFT_CHANGE_REQ
(
    DutyAID INTEGER(10) NOT NULL,
    DutyBID INTEGER(10) NOT NULL,
    Approved BINARY(1) NOT NULL,
    FOREIGN KEY (DutyAID) REFERENCES SHIFT_DUTY (DutyID),
    FOREIGN KEY (DutyBID) REFERENCES SHIFT_DUTY (DutyID),
    PRIMARY KEY (DutyAID, DutyBID)
);
